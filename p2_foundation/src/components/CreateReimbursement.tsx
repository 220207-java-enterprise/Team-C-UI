...
interface IReimbursementProps {
    ...
    createReimbursement: Reimbursement | undefined,
    setCreateReimbursement: (nextReimbursement: Reimbursement | undefined) => void
}
    ...
    let newReimbursment = async () => {
        ...
        try {
            ...
            if (resp.status === 200) {
                ...
                props.setCreateReimbursement(updatedUser);
                navigate('/login');
            }
